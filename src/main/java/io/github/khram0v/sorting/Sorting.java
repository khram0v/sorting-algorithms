...
public class Sorting {
     ...
     *
     * @param sortableList the `SortableList` instance containing the list of numbers to be sorted.
     * @param ascending if true, sorts in ascending order; if false, sorts in descending order.
     */
    public static void bubbleSort(SortableList<Integer> sortableList, boolean ascending) {
        // retrieve the list of numbers from the SortableList instance
        List<Integer> numbers = sortableList.getElements();
     ...
     * @param ascending if true, sorts in ascending order; if false, sorts in descending order.
     */
    public static void selectionSort(SortableList<Integer> sortableList, boolean ascending) {
        // retrieve the list of numbers from the SortableList instance
        List<Integer> numbers = sortableList.getElements();
        int size = numbers.size();
     ...
     * @param ascending if true, sorts in ascending order; if false, sorts in descending order.
     */
    public static void insertionSort(SortableList<Integer> sortableList, boolean ascending) {
        // retrieve the list of numbers from the SortableList instance
        List<Integer> numbers = sortableList.getElements();
        int size = numbers.size();
     ...
     * @param ascending if true, sorts in ascending order; if false, sorts in descending order.
     */
    public static void mergeSort(SortableList<Integer> sortableList, int left, int right, boolean ascending) {
        ...
        if (left < right) {
            ...
            mergeSort(sortableList, left, mid, ascending);
            // recursively sort the right half of the list
            mergeSort(sortableList, mid + 1, right, ascending);
            // merge two sorted halves back together
            merge(sortableList, left, mid, right, ascending);
        }
    }
     ...
     */
    private static void merge(SortableList<Integer> sortableList, int left, int mid, int right, boolean ascending) {
        // retrieve the list of numbers from the SortableList instance
        List<Integer> numbers = sortableList.getElements();
     ...
     *
     * @param sortableList the `SortableList` instance containing the list of numbers to be sorted.
     * @param low the starting index of the portion of the sortableList to sort.
     * @param high the ending index of the portion of the sortableList to sort.
     * @param ascending if true, sorts in ascending order; if false, sorts in descending order.
     */
    public static void quickSort(SortableList<Integer> sortableList, int low, int high, boolean ascending) {
        // check if the current segment has more than one element
        if (low < high) {
            // partition the list and get the index of the pivot
            int pivotIndex = partition(sortableList, low, high, ascending);

            // recursively sort the left sub-list
            quickSort(sortableList, low, pivotIndex - 1, ascending);
            // recursively sort the right sub-list
            quickSort(sortableList, pivotIndex + 1, high, ascending);
        }
    }

    /**
     * Partitions a section of the sortableList around a pivot element, organizing elements in either
     ...
     */
    private static int partition(SortableList<Integer> sortableList, int low, int high, boolean ascending) {
        // retrieve the list of numbers from the SortableList instance
        List<Integer> numbers = sortableList.getElements();
    ...
    public static void showInfo() {
        ...
        System.out.println("""
            ...
            The `merge` function combines two sorted sub-lists into a single sorted sortableList.
        Big O               |    Best    |         |   Average   |        |    Worst    |
